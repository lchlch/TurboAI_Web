...
export default observer(function () {
  ...
  //   setLoading(true);
  //   if (host.created_time)
  //     host.created_time = moment(host.created_time).format("YYYY-MM-DD");
  //   if (host.expired_time)
  //     host.expired_time = moment(host.expired_time).format("YYYY-MM-DD");
  //   http
  //     .post("/api/host/extend/", { host_id: host.hostId, ...host })
  //     .then((res) => {
  ...
  //   setFetching(true);
  //   http
  //     .get("/api/host/extend/", { params: { host_id: host.hostId } })
  //     .then((res) => {
  //       Object.assign(host, res);
  //       setHost(lds.cloneDeep(host));
  ...
  //         ? host.private_ip_address.push(tag)
  //         : (host.private_ip_address = [tag]);
  //     } else if (key === "gip") {
  //       host.public_ip_address
  //         ? host.public_ip_address.push(tag)
  //         : (host.public_ip_address = [tag]);
  //     }
  //     setHost(lds.cloneDeep(host));
  //   }
  //   setTag(undefined);
